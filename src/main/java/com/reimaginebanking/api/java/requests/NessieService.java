...
public interface NessieService {
    ...
    void createPurchase(@Query("key") String key, @Path("accountId") String accountId, @Body Purchase purchase, Callback<RequestResponse> cb);

    @PUT("/purchases/{purchaseId}")
    void updatePurchase(@Query("key") String key, @Path("purchaseId") String purchaseId, @Body Purchase purchase, Callback<RequestResponse> cb);
    ...
    void createTransfer(@Query("key") String key, @Path("accountId") String accountId, @Body Transfer transfer, Callback<RequestResponse> cb);

    @PUT("/transfers/{transferId}")
    void updateTransfer(@Query("key") String key, @Path("transferId") String transferId, @Body Transfer transfer, Callback<RequestResponse> cb);
    ...
    void createWithdrawal(@Query("key") String key, @Path("accountId") String accountId, @Body Withdrawal transaction, Callback<RequestResponse> cb);

    @PUT("/withdrawals/{withdrawalId}")
    void updateWithdrawal(@Query("key") String key, @Path("accountId") String accountId, @Body Withdrawal transaction, Callback<RequestResponse> cb);
